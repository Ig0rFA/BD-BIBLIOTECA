...
call Registra_Novo_Emprestimo(3,1,'2023-10-27','2024-01-27');

select estoque from livros where id = 3;
...
alter table emprestimos  add multas varchar(10.2);
...
call Recuperar_Livros_Emprestados(1);
call Calcular_Multa_Livros(1);
...
select * from Emprestimos_Detalhado;
